...
import static wumpusproject.HighScore.connect;
...
public class GameLogic implements Serializable {
    ...
    public GameLogic(char[][] board, int size) {
        ...
        System.out.println("Hero's starting position: [" + heroPosition.getRow() + ", " + heroPosition.getCol() + "]");
        System.out.println("Hero direction: " + getHeroDirection());
        System.out.println("Possesses the gold: " + hasGold);
        System.out.println("Number of arrows: " + heroArrows);
    ...
    public void playGame() {
        ...
        while (gameRunning) {
            ...
            System.out.println("8. Give up/Exit");
            System.out.println("9. Deferment");
            ...
            switch (choice) {
                ...
                case 8:
                    // (Feladás/Kilépés...)
                    gameRunning = false;
                    System.out.println("You've given up playing!/You've quit the game!");
                    break;
                case 9:
                    // (Halasztás (Pause)...)
                    pauseGame();
            ...
            if (gameOver()) {
                if (hasGold) {
                    System.out.println("Congratulations! You took the gold back!");
                } else {
                    System.out.println("You lost! The Wumpus killed me.");
                }
    ...
    private void moveHero() {
        ...
        if (isValidPosition(newHeroPosition) && board[newHeroPosition.getRow()][newHeroPosition.getCol()] != 'F') {
            ...
            System.out.println("You've hit a wall, you can't move on!");
        }
    ...
    private void shootArrow() {
        ...
        if (heroArrows > 0) {
            ...
            if (hitWumpus) {
                ...
                System.out.println("Successful shot! Wumpus is dead!");
            } else {
                System.out.println("The shot failed. The arrow broke in two, hitting the wall.");
            }
        }
    }
    ...
    private void printGameBoard() {
        ...
        System.out.println("Hero's position: [" +
                heroPosition.getRow() + ", " +
                heroPosition.getCol() + "]");
        System.out.println("Hero direction: " + getHeroDirection());
        System.out.println("Number of arrows: " + heroArrows);
        System.out.println("Owns the gold: " + hasGold);
    }
    ...
    private void pauseGame() {
        ...
        try (Connection connection = connect()) {
            saveGameState(connection, "TestPlayer", this);
            System.out.println("Game progress saved and resumed!");
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
